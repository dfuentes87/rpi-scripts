...
### Setup a Raspberry Pi (on Debian/Raspbian/Ubuntu) with Ubiquiti UniFi Controller and Pi-hole ###
...
echo -e "${color}By using this script, you'll fully update the system, install the UniFi Controller \
and install Pi-hole.\n\n${nocolor}"
